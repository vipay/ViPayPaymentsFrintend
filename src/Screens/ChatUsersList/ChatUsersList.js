...
import {View, Text, StyleSheet, Image, Platform, Keyboard, FlatList} from 'react-native';
...
const ChatUsersList = () => {
    const data=[
        ...
        },
        {
            ...
            name:'Anni Nikola',
            time:'Yesterday',
            message:'Actually I wanted to check with you about your online business plan on… ',
        },
        {
            id:5,
