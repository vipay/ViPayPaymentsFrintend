...
const WalletList = ({navigation}) => {
  ...
  const sendAddress = (item, index) => {
    console.log(item.item,"lllllppppppl")
    navigation.navigate(navigationStrings.SENDWALLETENTERAMOUNT, {
  ...
  const renderItem = (item, index) => {
    ...
    return (
      <TouchableOpacity onPress={()=>sendAddress(item, index)}>
